define([
	...
	function fillContent(){
		...
		if (SKBeInstant.isWLA()) {
			...
			tHead = '<table><thead><th>'+ loader.i18n.Game.prizeLevel + '</th></thead>';
		}
		
		if (SKBeInstant.isWLA()) {
			for (i = 0; i < revealConfigurations.length; i++) {
				var numberOfRemainingWinners = 0, numberOfUnsoldWagers;
		...
		if(SKBeInstant.isWLA()){             
			...
			payback = '<section><h3>'+ loader.i18n.Paytable.paybackTitle +'</h3><p>'+loader.i18n.Paytable.paybackBody+'</p></section>';
